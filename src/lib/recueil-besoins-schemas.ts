    ...
    sections: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "number",
            suffix: "€ / mois",
            help: "Première cotisation d'assurance indiquée sur l'offre ou l'échéancier. Elle n'est pas considérée constante si le document montre une cotisation dégressive.",
          },
          {
            key: "assurance_banque_cout_total",
            label: "Coût total de l’assurance bancaire",
            type: "number",
            suffix: "€",
            help: "Montant total écrit dans l’offre de prêt ou totalisé dans le tableau d’amortissement. Il prime sur tout calcul.",
          },
        ],
      },
      {
