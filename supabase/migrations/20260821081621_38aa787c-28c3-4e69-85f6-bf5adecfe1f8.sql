-- 5) Historique des appels de cotisation conservé après résiliation/annulation :
-- on ne régénère plus les échéances d'un contrat sorti du portefeuille, afin de
-- garder la trace des appels déjà émis avant la sortie.
...
BEGIN
  ...
  -- Contrat sorti du portefeuille : l'historique des appels de cotisation déjà
  -- émis est figé et conservé tel quel.
