-- Tâche automatique dès qu'un document arrive sur un dossier (dépôt manuel,
-- import automatique depuis un mail partenaire, etc.) : le cabinet doit
-- savoir qu'une pièce est arrivée sans avoir à la découvrir par hasard.
-- Ne crée rien si le document n'est rattaché à aucun dossier (dépôt en
-- "à classer", pas encore identifié).
