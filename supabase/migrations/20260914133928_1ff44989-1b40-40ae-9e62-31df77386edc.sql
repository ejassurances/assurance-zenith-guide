...
DECLARE
  _cles_autorisees text[] := ARRAY[
    ...
    'date_premiere_echeance','taux_assurance_banque','assurance_banque_mensuelle',
    'assurance_banque_cout_total','fractionnement','garanties_acceptees',
    'notes_contrat','origine','produit','quotite'
  ];
  _cles_assure_autorisees text[] := ARRAY['lien','prenom','nom','date_naissance','quotite_pct','csp','fumeur'];
  _cle text;
  _assures jsonb;
